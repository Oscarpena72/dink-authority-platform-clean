                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm rounded-full font-semibold transition-all ${
                    (category ?? '') === (c?.value ?? '')
                      ...
                      : 'bg-brand-gray text-brand-purple hover:bg-brand-purple/10'
                  }`}
                >
                  {c?.label}
                </button>
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-10">
              <button
                ...
                className="p-2 rounded bg-brand-gray hover:bg-brand-purple hover:text-white disabled:opacity-30 transition-all"
              >
                <ChevronLeft size={18} />
              </button>
              {Array.from({ length: totalPages }, (_, i: number) => i + 1).map((p: number) => (
                <button
                  ...
                  className={`w-10 h-10 rounded font-bold text-sm transition-all ${
                    p === currentPage ? 'bg-brand-purple text-white' : 'bg-brand-gray text-brand-purple hover:bg-brand-purple/10'
                  }`}
                >
                  {p}
                </button>
