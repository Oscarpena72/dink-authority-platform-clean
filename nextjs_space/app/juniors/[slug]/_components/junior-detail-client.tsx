...
function InstagramVideoModule({ url, t }: { url: string; t: (key: any) => string }) {
  if (!url) return null;
  return (
    <div className="my-10">
      ...
      <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 p-[2px]">
        <div className="bg-white rounded-[10px] p-6 md:p-8 flex flex-col items-center justify-center text-center min-h-[200px]">
          ...
          <p className="text-gray-600 text-sm mb-4 max-w-md">{t('juniors.watchOnInstagramDesc')}</p>
          <a href={url} target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-white font-bold rounded-full hover:brightness-110 transition-all shadow-lg">
            <Instagram size={18} /> {t('juniors.watchOnInstagram')} <ExternalLink size={16} />
          </a>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <article className="max-w-4xl mx-auto px-4 py-10">
          ...
          <InstagramVideoModule url={junior?.instagramVideoUrl ?? ''} t={t} />
