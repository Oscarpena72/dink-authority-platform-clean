...
const translations = {
  ...
  // Juniors
  'nav.juniors': { en: 'Juniors', es: 'Juniors', pt: 'Juniors' },
  'juniors.title': { en: 'Juniors', es: 'Juniors', pt: 'Juniors' },
  'juniors.subtitle': { en: 'The next generation of pickleball stars', es: 'La próxima generación de estrellas del pickleball', pt: 'A próxima geração de estrelas do pickleball' },
  'juniors.readStory': { en: 'Read Story', es: 'Leer Historia', pt: 'Ler História' },
  'juniors.by': { en: 'By', es: 'Por', pt: 'Por' },
  'juniors.editorial': { en: 'Dink Authority Magazine', es: 'Dink Authority Magazine', pt: 'Dink Authority Magazine' },
  'juniors.watchOnInstagram': { en: 'Watch on Instagram', es: 'Ver en Instagram', pt: 'Ver no Instagram' },
  'juniors.shareTitle': { en: 'Share this story', es: 'Compartir esta historia', pt: 'Compartilhar esta história' },
  'juniors.copyLink': { en: 'Copy Link', es: 'Copiar enlace', pt: 'Copiar link' },
  'juniors.copied': { en: 'Copied!', es: '¡Copiado!', pt: 'Copiado!' },
  'juniors.gallery': { en: 'Gallery', es: 'Galería', pt: 'Galeria' },
  'juniors.relatedJuniors': { en: 'More Juniors', es: 'Más Juniors', pt: 'Mais Juniors' },
  'juniors.backToJuniors': { en: 'Back to Juniors', es: 'Volver a Juniors', pt: 'Voltar a Juniors' },
  'juniors.translating': { en: 'Translating...', es: 'Traduciendo...', pt: 'Traduzindo...' },
  'juniors.translated': { en: 'Translated', es: 'Traducido', pt: 'Traduzido' },
  'juniors.translationFailed': { en: 'Translation unavailable', es: 'Traducción no disponible', pt: 'Tradução não disponível' },
  'juniors.viewOriginal': { en: 'View Original', es: 'Ver Original', pt: 'Ver Original' },
  'juniors.noJuniors': { en: 'No juniors stories available yet. Check back soon!', es: '¡Aún no hay historias de juniors disponibles. ¡Vuelve pronto!', pt: 'Nenhuma história de juniors disponível ainda. Volte em breve!' },
  'juniors.yearsOld': { en: 'years old', es: 'años', pt: 'anos' },
  'juniors.age': { en: 'years old', es: 'años', pt: 'anos' },
  'juniors.watchVideo': { en: 'Watch Video', es: 'Ver Video', pt: 'Assistir Vídeo' },
  'juniors.watchOnInstagramDesc': { en: 'Watch this player in action on Instagram', es: 'Mira a este jugador en acción en Instagram', pt: 'Assista este jogador em ação no Instagram' },
  'juniors.latestEdition': { en: 'Latest Edition', es: 'Última Edición', pt: 'Última Edição' },
  'juniors.readNow': { en: 'Read Now', es: 'Leer Ahora', pt: 'Ler Agora' },
  ...
  'community.heroTitle': { en: 'Become a Dink Authority Community Correspondent', es: 'Conviértete en corresponsal de Dink Authority', pt: 'Torne-se um correspondente da Dink Authority' },
  'community.heroSubtitle': { en: 'Your community has stories the world deserves to see.', es: 'Tu comunidad tiene historias que el mundo merece conocer.', pt: 'Sua comunidade tem histórias que o mundo merece conhecer.' },
  'community.tagline1': { en: 'Every great story deserves to be told.', es: 'Toda buena historia merece ser contada.', pt: 'Toda boa história merece ser contada.' },
  'community.tagline2': { en: 'Every talent deserves to be seen.', es: 'Todo talento merece ser expuesto.', pt: 'Todo talento merece ser revelado.' },
  'community.editorialP1': { en: 'Pickleball is growing everywhere.', es: 'El pickleball está creciendo en todas partes.', pt: 'O pickleball está crescendo em todos os lugares.' },
  'community.editorialP2': { en: 'In your club, your city or your community, incredible stories are happening every day.', es: 'En tu club, tu ciudad o tu comunidad están ocurriendo historias increíbles todos los días.', pt: 'Em seu clube, cidade ou comunidade, histórias incríveis estão acontecendo todos os dias.' },
  'community.editorialP3': { en: 'Maybe you know a player whose journey deserves to be shared.', es: 'Tal vez conoces a un jugador cuya historia merece ser contada.', pt: 'Talvez você conheça um jogador cuja história merece ser contada.' },
  'community.editorialP4': { en: 'Maybe you have seen future champions who deserve exposure.', es: 'Tal vez has visto futuros campeones que merecen ser presentados al mundo.', pt: 'Talvez você tenha visto futuros campeões que merecem visibilidade.' },
  'community.editorialP5': { en: 'If you have passion for pickleball and a good eye for great stories, we want to hear from you.', es: 'Si tienes pasión por el pickleball y buen ojo para las grandes historias, queremos conocerte.', pt: 'Se você tem paixão pelo pickleball e um bom olhar para grandes histórias, queremos conhecer você.' },
  'community.editorialP6': { en: 'Join the Dink Authority Community Network and help us showcase the best of the sport around the world.', es: 'Únete a la red comunitaria de Dink Authority y ayúdanos a mostrar lo mejor de este deporte.', pt: 'Junte-se à rede comunitária da Dink Authority.' },
  'community.benefitsTitle': { en: 'What You Get', es: 'Lo que obtienes', pt: 'O que você ganha' },
  'community.benefit1': { en: 'The best stories may be featured in Dink Authority Magazine', es: 'Las mejores historias pueden ser publicadas en Dink Authority Magazine', pt: 'As melhores histórias podem ser publicadas na Dink Authority Magazine' },
  'community.benefit2': { en: 'Exposure on the Dink Authority platform', es: 'Exposición en la plataforma de Dink Authority', pt: 'Exposição na plataforma da Dink Authority' },
  'community.benefit3': { en: 'Promotion through social media', es: 'Promoción a través de redes sociales', pt: 'Promoção nas redes sociais' },
  'community.benefit4': { en: 'Correspondent credit in articles and posts', es: 'Crédito de corresponsal en artículos y publicaciones', pt: 'Crédito de correspondente em artigos e publicações' },
  'community.benefit5': { en: 'Opportunity to showcase talent from your community', es: 'Oportunidad de mostrar el talento de tu comunidad', pt: 'Oportunidade de mostrar o talento da sua comunidade' },
  'country.ctaTagline': { en: 'JOIN THE TEAM', es: 'ÚNETE AL EQUIPO', pt: 'JUNTE-SE AO TIME' },
  'country.ctaCorrespondent': { en: 'Become a Community Correspondent', es: 'Conviértete en Corresponsal de la Comunidad', pt: 'Torne-se um Correspondente da Comunidade' },
  'country.ctaCorrespondentDesc': { en: 'Share the stories of your local pickleball community with the world.', es: 'Comparte las historias de tu comunidad local de pickleball con el mundo.', pt: 'Compartilhe as histórias da sua comunidade local de pickleball com o mundo.' },
  'country.ctaLearnMore': { en: 'Learn More', es: 'Saber Más', pt: 'Saiba Mais' },
  'community.formTitle': { en: 'Register as a Correspondent', es: 'Regístrate como Corresponsal', pt: 'Registre-se como Correspondente' },
  'community.firstName': { en: 'First Name', es: 'Nombre', pt: 'Nome' },
  'community.lastName': { en: 'Last Name', es: 'Apellido', pt: 'Sobrenome' },
  'community.city': { en: 'City', es: 'Ciudad', pt: 'Cidade' },
  'community.state': { en: 'State', es: 'Estado', pt: 'Estado' },
  'community.address': { en: 'Address', es: 'Dirección', pt: 'Endereço' },
  'community.zipCode': { en: 'Zip Code', es: 'Código Postal', pt: 'CEP' },
  'community.phone': { en: 'Phone', es: 'Teléfono', pt: 'Telefone' },
  'community.email': { en: 'Email', es: 'Correo Electrónico', pt: 'E-mail' },
  'community.facebook': { en: 'Facebook URL', es: 'Facebook URL', pt: 'Facebook URL' },
  'community.instagram': { en: 'Instagram URL', es: 'Instagram URL', pt: 'Instagram URL' },
  'community.tiktok': { en: 'TikTok URL', es: 'TikTok URL', pt: 'TikTok URL' },
  'community.messageLabel': { en: 'Tell us anything you want', es: 'Escríbenos lo que quieras', pt: 'Escreva o que quiser' },
  'community.messageHint': { en: 'You can tell us about your community, talents you\'ve seen, local tournaments, or why you\'d like to be part of the Dink Authority network.', es: 'Puedes contarnos sobre tu comunidad, talentos que has visto, torneos locales o por qué te gustaría formar parte de la red de Dink Authority.', pt: 'Você pode nos contar sobre sua comunidade, talentos que viu, torneios locais ou por que gostaria de fazer parte da rede da Dink Authority.' },
  'community.submit': { en: 'Submit Registration', es: 'Enviar Registro', pt: 'Enviar Registro' },
  'community.submitting': { en: 'Submitting...', es: 'Enviando...', pt: 'Enviando...' },
  'community.successTitle': { en: 'Thank you for registering.', es: 'Gracias por registrarte.', pt: 'Obrigado por se registrar.' },
  'community.successText': { en: 'Our editorial team will review your submission and contact you soon.', es: 'Nuestro equipo editorial revisará tu información y pronto se pondrá en contacto contigo.', pt: 'Nossa equipe editorial revisará suas informações e entrará em contato em breve.' },
  'community.shareTitle': { en: 'Share this opportunity', es: 'Comparte esta oportunidad', pt: 'Compartilhe esta oportunidade' },
  'community.copyLink': { en: 'Copy Link', es: 'Copiar enlace', pt: 'Copiar link' },
  'community.copied': { en: 'Copied!', es: '¡Copiado!', pt: 'Copiado!' },
  'community.required': { en: 'Required', es: 'Obligatorio', pt: 'Obrigatório' },
  'community.ctaTitle': { en: 'YOU ARE THE REPORTER', es: 'EL REPORTERO ERES TÚ', pt: 'O REPÓRTER É VOCÊ' },
  'community.ctaSubtitle1': { en: 'Be part of the Dink Authority network', es: 'Forma parte de la red de Dink Authority', pt: 'Faça parte da rede da Dink Authority' },
  'community.ctaSubtitle2': { en: 'Elevate your community to the next level', es: 'Eleva tu comunidad a otro nivel', pt: 'Eleve sua comunidade a outro nível' },
  'community.ctaLine1': { en: 'Every great story deserves to be told', es: 'Toda buena historia merece ser contada', pt: 'Toda boa história merece ser contada' },
  'community.ctaLine2': { en: 'Every talent deserves to be seen', es: 'Todo talento merece ser expuesto', pt: 'Todo talento merece ser revelado' },
  'community.ctaButton': { en: 'REGISTER', es: 'REGÍSTRATE', pt: 'REGISTRE-SE' },
